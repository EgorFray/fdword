function TemplateCard({ headingCount }) {
  return (
    <div className="flex h-55 w-37.5 cursor-pointer flex-col rounded-xl bg-white p-4 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)] hover:ring-2 hover:ring-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 md:h-60 md:w-53.5">
